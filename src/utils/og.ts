...
export function ogSvg(app?: CyberApp, lang: Lang = 'en'): string {
  ...
  const extra = app ? app.stack : lang === 'es' ? 'cybergems.org — Sin cuenta · Sin anuncios · Sin rastreo en apps · GPLv3' : 'cybergems.org — No account · No ads · No app tracking · GPLv3';
...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg" role="img">
  ...
  <text x="70" y="590" fill="#9a9aa5" font-family="Segoe UI, system-ui, sans-serif" font-size="16">Free • No Account • No Ads • No App Tracking • Open Source</text>
  <!-- URL -->
